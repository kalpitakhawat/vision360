                    ...
                    <div class="container-fluid flex-center">
                        <div class="row flex-center pt-5 mt-3">
                            <div class="col-md-12 col-lg-8 text-center text-md-left margins">
                                <img src="/img/banner.png" alt="" class="wow fadeInLeft" >
                            ...
                            <div class="col-md-12 col-lg-4 wow fadeInRight d-flex justify-content-center" data-wow-delay="0.3s">
                        ...
                        <div class="col-12 col-md-8 ">
                            ...
                            <div class="list-group transparent">
                                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="d-flex w-100 justify-content-between">
                                        <small> Donec id elit non mi porta.Donec id elit non mi porta. Donec id elit non mi porta.</small>
                            ...
                            <div class="row">
                                <div class="col-12 mt-5">
                                    <img src="/img/add2.jpg" width="100%">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 mt-2">
                                    <img src="/img/add3.jpg" width="100%">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 ">
                            <h4 class="text-center h4 mb-5">Upcoming Events</h4>
                            <!--Card Narrower-->
