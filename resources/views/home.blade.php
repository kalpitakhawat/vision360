                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="text-center card card-cascade narrower">
                                            ...
                                            <div class="view overlay hm-white-slight">
                                                <img src="/covers/{{$event->cover_image}} " class="img-fluid" alt="" style="max-width: 100%">
                                                <a>
                                                    <div class="mask"></div>
                                                </a>
                                            </div>
                                            ...
                                            <!--Card content-->
                                            <div class="card-body">
                                                <h5 class="pink-text"><i class="fa fa-calendar"></i>{{$event->time}} </h5>
                                                <!--Title-->
                                                <h4 class="card-title">{{$event->title}} </h4>
                                                <a class="btn btn-unique" href="/events/{{$event->id}}">View Details</a>
                                            </div>
                                            <!--/.Card content-->
                                        </div>
                                        <!--/.Card Narrower-->
