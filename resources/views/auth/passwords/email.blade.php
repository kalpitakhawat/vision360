                        ...
                        <div class="card" style="min-width: 100px;">
                            <div class="card-body mx-5">
                                ...
                                <div class="text-center mb-3">
                                    <button type="submit" class="btn btn-primary waves-effect waves-light z-depth-1a">Send Password Reset Link</button>
                                </div>
                                </form>
                            </div>
                            <!--Footer-->
                            <div class="modal-footer pt-3 mb-1 justify-content-center">
                                <p class="font-small grey-text d-flex justify-content-center"><a href="/login" class="blue-text">Back To Login</a></p>
                            </div>
                        </div>
                        <!--/Form without header-->
                    </section>
